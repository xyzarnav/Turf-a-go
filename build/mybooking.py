...
class TurfBookingTable:
    def __init__(self, parent):
        ...
        headers = ["BK. ID", "Turf Name", "Date", "Time Slot", "Amount Paid", "Amount Due"]
        for i, header in enumerate(headers):
            label = tk.Label(self.parent, text=header, font=("Arial", 12, "bold"), relief="solid", bd=1 ,justify='center',height=3,width=8)
    ...
    def get_row_data(self):
        ...
        rows = [
            [1, "Turf A", "2022-01-01", "10:00 AM - 12:00 PM", 100, 50],
            [2, "Turf B", "2022-01-02", "02:00 PM - 04:00 PM", 150, 0],
            # Add more rows here...
        ]
        return rows
